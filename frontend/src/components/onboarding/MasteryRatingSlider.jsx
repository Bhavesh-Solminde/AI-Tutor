...
const MasteryRatingSlider = ({ topic, rating, onChange }) => {
  return (
    <div className="p-4 rounded-xl border border-border-light dark:border-border-dark bg-slate-50 dark:bg-surface-dark space-y-3">
      <div className="flex justify-between items-center text-left">
        <span className="text-sm font-semibold text-slate-800 dark:text-text-primary-dark">{topic}</span>
