          ...
          {isChatEmpty ? (
            <div className="flex-grow flex flex-col items-center justify-center space-y-7 py-8 my-auto">
              ...
              <div className="text-center space-y-2">
                <h3 className="font-extrabold text-2xl text-slate-800 dark:text-white">Hello, I'm NeuralNest</h3>
              ...
              {/* Footer Quick Links */}
              <div className="flex items-center justify-center space-x-2 text-xs text-slate-400 dark:text-slate-500 pt-3">
                <button className="hover:text-slate-600 dark:hover:text-slate-300 transition-colors">View More</button>
                <span>•</span>
