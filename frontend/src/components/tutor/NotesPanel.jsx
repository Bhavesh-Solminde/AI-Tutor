    ...
    <div className="border border-border-light dark:border-border-dark rounded-2xl bg-white dark:bg-surface-dark overflow-y-auto p-6 text-left shadow-sm flex flex-col justify-between h-full">
      <div className="space-y-6">
        <div className="flex items-center space-x-2 pb-3 border-b border-border-light/40 dark:border-border-dark/40">
          ...
          <span className="text-xs font-mono text-slate-400">Class notes: OS_Syllabus_Unit1.pdf</span>
        </div>

        <article className="prose dark:prose-invert max-w-none text-sm leading-relaxed space-y-4 text-slate-600 dark:text-slate-300">
          <h3 className="text-lg font-bold text-slate-800 dark:text-white">1.1 Introduction to Processor Scheduling</h3>
          <p>
          ...
          <h4 className="text-base font-semibold text-slate-800 dark:text-white">Scheduling Criteria</h4>
          ...
          <h4 className="text-base font-semibold text-slate-800 dark:text-white">First-Come, First-Served (FCFS)</h4>
          <p>
      ...
      <div className="mt-6 p-4 rounded-xl bg-slate-50 dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800 flex items-start space-x-3 text-xs text-slate-500">
