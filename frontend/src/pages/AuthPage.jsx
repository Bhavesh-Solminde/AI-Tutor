...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark text-slate-800 dark:text-text-primary-dark transition-colors duration-300 relative overflow-hidden flex flex-col justify-center items-center py-12 px-6">
      ...
      <div className="w-full max-w-md p-8 rounded-2xl border border-border-light dark:border-border-dark bg-white dark:bg-surface-dark shadow-2xl relative z-10">
        <div className="absolute -top-12 -left-12 w-24 h-24 bg-primary/20 dark:bg-accent/20 rounded-full blur-2xl pointer-events-none" />
